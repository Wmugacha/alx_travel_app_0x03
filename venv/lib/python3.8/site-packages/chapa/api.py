...
class Chapa:
    ...
    def verify(self, transaction: str, headers=None) -> Union[dict, Response]:
    ...
    def get_banks(self, headers=None) -> Union[dict, Response]:
    ...
    def verify_transfer(self, reference: str) -> Union[dict, Response]:
